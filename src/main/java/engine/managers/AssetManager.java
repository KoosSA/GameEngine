...
public class AssetManager {
	...
	private static AmbientLight ambientLight = new AmbientLight(new Vector3f(1,1,1)).setIntensity(0.1f);
	private static DirectionalLight directionalLight = new DirectionalLight(new Vector3f(0.5f,-0.5f,-0.5f), new Vector3f(1)).setIntensity(3);
